...
| [CopilotKit (Deep Agents)](/oss/python/integrations/middleware/copilotkit) | CopilotKit `CopilotKitMiddleware` for [Deep Agents](/oss/python/deepagents/overview) and AG-UI, plus React and runtime packages. | [`CopilotKit/CopilotKit`](https://github.com/CopilotKit/CopilotKit) |
