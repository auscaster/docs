...
| [CopilotKit (Deep Agents)](/oss/integrations/middleware/copilotkit) | CopilotKit `CopilotKitMiddleware` for [Deep Agents](/oss/deepagents/overview) and AG-UI, plus React and runtime packages. | [`CopilotKit/CopilotKit`](https://github.com/CopilotKit/CopilotKit) |
