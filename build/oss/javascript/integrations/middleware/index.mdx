...
| [CopilotKit (Deep Agents)](/oss/javascript/integrations/middleware/copilotkit) | CopilotKit [CopilotKitMiddleware](https://docs.copilotkit.ai/langgraph/deep-agents) for [Deep Agents](/oss/javascript/deepagents/overview) and AG-UI, plus TypeScript [CopilotRuntime](https://www.npmjs.com/package/@copilotkit/runtime) and [React](https://www.npmjs.com/package/@copilotkit/react-core) clients. | [`CopilotKit/CopilotKit`](https://github.com/CopilotKit/CopilotKit) |
