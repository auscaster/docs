...
| [CopilotKit](/oss/python/integrations/middleware/copilotkit) | CopilotKit `CopilotKitMiddleware` and FastAPI bridge for [Deep Agents](/oss/python/deepagents/overview), `create_agent` graphs, AG-UI, and the React and runtime clients. | [`CopilotKit/CopilotKit`](https://github.com/CopilotKit/CopilotKit) |
